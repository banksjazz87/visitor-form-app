...
export default function ThankYouMessage({show}: ThankYouProps) {
    if (show) {
        return (
            <div className="bg-gradient-to-br from-slate-900 to-gray-800 text-white h-screen flex flex-col items-center justify-start min-h-full md:justify-center">
                <div className="flex flex-col w-11/12 mt-5 md:w-8/12">
                    ...
                    <h2 className="text-4xl font-extrabold text-center mb-0 mt-5 md:text-5xl md:mt-14">Thank You!</h2>
                    ...
                    <div className="flex flex-col justify-center gap-8 mt-4 md:flex-row md:mt-16">
                        <a
                            href="https://www.facebook.com/chapelonthhill"
                            target="_blank"
                            rel="noreferrer"
                            className="bg-fuchsia-800 hover:bg-fuchsia-900 transition-colors ease-in-out delay-200 py-4 px-20 text-xl rounded-full  capitalize tracking-wider text-white text-center"
                        >
                            Facebook
                        </a>
                        <a
