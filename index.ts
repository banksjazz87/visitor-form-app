...
app.post("/add-visitor-to-all", (req: Request, res: Response): void => {
	...
	const emailList = "banksjazz87@gmail.com, whitneylanematthews@yahoo.com, whitneymatthews05@gmail, chapelonthehill@embarqmail.com, thefarki@icloud.com, chapelonthehillag316@gmail.com";
